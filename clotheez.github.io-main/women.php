...
<body>
       ...
       <div class="banner">
            <div class="container">
                    <div class="slider-item">
                        <img src="./img/women-banner-4.png" alt="Women Banner" class="banner-img">
    ...
    <div class="banner">
            <div class="container">
                    <div class="slider-item">
                        <img src="./img/women-banner-3.png" alt="Mens Banner" class="banner-img">
                    </div>
            </div>
        </div>
